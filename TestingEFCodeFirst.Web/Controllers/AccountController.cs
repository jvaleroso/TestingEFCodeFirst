...
using TestingEFCodeFirst.Web.Models;
using TestingEFCodeFirst.Web.Providers;
using TestingEFCodeFirst.Web.Results;

namespace TestingEFCodeFirst.Web.Controllers
{
    [Authorize]
